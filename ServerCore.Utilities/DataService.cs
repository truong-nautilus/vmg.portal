...
namespace ServerCore.Utilities
{
    public class DataService : IDataService
    {
        ...
        public async Task<T> GetApiAsync<T>(string uri, dynamic token, bool isLog = true, bool isAuthen = false, int timeout = 30000)
        {
            try
            {
                using (var cts = new CancellationTokenSource())
        ...
        public async Task<T> PostApiAsync<T>(string uri, dynamic data, dynamic token, bool isLog = true, int timeout = 30000)
        {
            try
            {
                using (var cts = new CancellationTokenSource())
