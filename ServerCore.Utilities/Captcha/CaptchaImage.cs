...
namespace ServerCore.Utilities.Captcha
{
    public class CaptchaImage
    {
        ...
        private PointF RandomPoint(Rectangle rect)
        {
            ...
            PointF r = RandomPoint(rect.Left, rect.Width, ref top, ref Bottom);
        ...
        private void WarpText(GraphicsPath textPath, Rectangle rect)
        {
            ...
            if (height > this.Height)
                height = this.Height;
            int top12 = top + hrange;
            int left12 = height - hrange;
            PointF leftTop = RandomPoint(left, left + wrange, ref top, ref top12);
            PointF rightTop = RandomPoint(width - wrange, width, ref top, ref top12);
            PointF leftBottom = RandomPoint(left, left + wrange, ref left12, ref height);
            PointF rightBottom = RandomPoint(width - wrange, width, ref left12, ref height);
