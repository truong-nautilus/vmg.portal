...
namespace PortalAPI.Controllers
{
    ...
    public class OTPAPIController : ControllerBase
    {
        ...
        public OTPAPIController(IOTPDAO iOTPDAO, IAccountDAO accountDAO, IAgencyDAO agencyDAO, AccountSession accountSession, OTPSecurity otpSecurity, IAuthenticateService authenticateService, Captcha captchaUtil)
        {
        ...
        public ActionResult<ResponseBuilder> ChangePassVerifyOTP([FromBody] OtpModel model)
        {
            try
            {
                ...
                int response = _accountDAO.ChangePassword(_accountSession.AccountID, oldPassEnc, newPassEnc);
