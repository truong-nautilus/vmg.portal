...
namespace PortalAPI.Controllers
{
    ...
    public class AccountAPIController : ControllerBase
    {
        ...
        public ActionResult<ResponseBuilder> GetLocation()
        {
            try
            {
                var result = _accountDAO.GetLocationRegister();
                if (result.Count > 0)
                {
        ...
        public ActionResult<ResponseBuilder> GetMobileCodes()
        {
            try
            {
                var result = _accountDAO.GetMobileCodes();
                if (result.Count > 0)
                {
                    return new ResponseBuilder(ErrorCodes.SUCCESS, _accountSession.Language, result);
                }
        ...
        public ActionResult<ResponseBuilder> ChangePassword(ChangePasswordData data)
        {
            try
            {
                ...
                {
                    AccountEbank accountCheckFB = _accountDAO.Get(_accountSession.AccountID);
        ...
        public ActionResult<ResponseBuilder> GiftCode(string giftCode, string captcha, string verifyCaptcha)
        {
            ...
            try
            {
                ...
                var securityInfo = _accountDAO.GetSecurityInfo(_accountSession.AccountID);
                // Tài khoản chưa đăng ký bảo mật OTP
        ...
        public ActionResult<ResponseBuilder> ResetPassword(ResetPassModels model)
        {
            try
            {
                ...
                int result_reset = _accountDAO.ResetPassword(account.AccountName, newPass, (short)model.Type);
                if (result_reset < 0)
                {
        ...
        public ActionResult<ResponseBuilder> HardResetPassword(ResetPassModels model)
        {
            try
            {
                ...
                if (model.Type == 9) // Hard reset
                {
                    ...
                    int result_reset = _accountDAO.ResetPassword(account.AccountName, model.NewPassword, (short)model.Type);
                    if (result_reset < 0)
                    {
        ...
        public ActionResult<ResponseBuilder> UpdateUserFullName(string fullName, string captcha, string captchaToken, string refCode = "")
        {
            try
            {
                ...
                int response = _accountDAO.UpdateUserFullName(_accountSession.AccountName, _accountSession.AccountID, fullName, refCode);
            ...
            try
            {
                ...
                if (securityInfo != null)
                {
                    ...
                    if (model.Type == 1) // Đăng ký bảo mật
                    {
                        ...
                        long balance = 0;
                        int res = _accountDAO.RegisterOTP((int)_accountSession.AccountID, _accountSession.AccountName, securityInfo.Mobile, (int)RegisterOTPType.REGISTER_OTP, out balance);
                        if (res >= 0)
                        {
                            if (balance > 0)
                            {
                            ...
                            accountDb.PlatformID = _accountSession.PlatformID;
                            accountDb.ClientIP = _accountSession.IpAddress;
                            accountDb.IsAgency = _agencyDao.CheckIsAgency((int)_accountSession.AccountID);
        ...
        public ActionResult<ResponseBuilder> UpdateAccountWorldBank(dynamic data)
        {
            ...
            try
            {
                ...
                long res = _accountDAO.UpdateAccountWorldBank(accountId, bankName, bankAccountName, bankAccountNumber, bankID);
                if (res >= 0)
                {
                    return new ResponseBuilder(ErrorCodes.SUCCESS, _accountSession.Language);
                }
        ...
        public ActionResult<ResponseBuilder> GetWorldBanks()
        {
            try
            {
                ...
                var lst = _accountDAO.GetWorldBank(locationID, prefix);
        ...
        public ActionResult<ResponseBuilder> GetAccountWorldBanks()
        {
            try
            {
                ...
                var accountWorldBank = _accountDAO.GetAccountWorldBank(accountID);
        ...
        public ActionResult<ResponseBuilder> GetAccountGeneral()
        {
            try
            {
                ...
                var data = _accountDAO.GetAccountGeneral(accountID);
        ...
        public ActionResult<ResponseBuilder> EditPassword(EditPassword param)
        {
            ...
            try
            {
                ...
                var response = _accountDAO.ChangePassword(accountID, param.OldPassword, param.NewPassword);
                if (response >= 0)
                    return new ResponseBuilder(ErrorCodes.SUCCESS, _accountSession.Language);
        ...
        public ActionResult<ResponseBuilder> EdiAccountGeneral([FromBody] dynamic data)
        {
            ...
            try
            {
                ...
                var accountID = _accountSession.AccountID;
                var result = _accountDAO.UpdateInfo(accountID, email, mobile, "", avatar, nickname, locationID);
        ...
        public ActionResult<ResponseBuilder> GetLoginSessions()
        {
            ...
            {
                var accountID = _accountSession.AccountID;
                var result = _accountDAO.GetLoginSessions(accountID);
        ...
        public ActionResult<ResponseBuilder> RemoveLoginSession([FromBody] dynamic data)
        {
            ...
            try
            {
                ...
                var accountID = _accountSession.AccountID;
                var result = _accountDAO.RemoveLoginSession(sessionID, accountID);
