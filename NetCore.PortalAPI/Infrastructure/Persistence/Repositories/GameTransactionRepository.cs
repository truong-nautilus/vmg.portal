...
namespace NetCore.PortalAPI.Infrastructure.Persistence.Repositories
{
    public class GameTransactionRepository : IGameTransactionRepository
    {
        ...
        public GameTransactionRepository(IDBHelper dbHelper, IOptions<AppSettings> options)
        {
        ...
        List<TransferBonHistory> IGameTransactionRepository.GetTransferBonHistory(int accountId, int type)
        {
            try
            {
