...
namespace NetCore.PortalAPI.Infrastructure.Persistence.Repositories
{
    public class OTPRepository : IOTPRepository
    {
        ...
        public OTPRepository(IDBHelper dbHelper, IOptions<AppSettings> options)
        {
        ...
        public OTPs.ResponMes SetupAppToken(OTPs.SetupAppTokenOutput input)
        {
	     ...
	     //   @_ResponseCode INT = -1 OUTPUT
            ...
            try
            {
                ...
                _dbHelper.ExecuteNonQuerySP("SP_OTPApp_SetupAppToken", pars);
        ...
        public int AccountVerifySMS(OTPs.AccountVerifySms input)
        {
            ...
            try
            {
                ...
                _dbHelper.SetConnectionString(appSettings.BillingAuthenticationAPIConnectionString);
                _dbHelper.ExecuteNonQuerySP("SP_Account_VerifySMS", pars);
        ...
        public int TokensSyncTime(OTPs.CheckActiveSyncTime input)
        {
            try
            {
                ...
                _dbHelper.SetConnectionString(appSettings.BillingAuthenticationAPIConnectionString);
                _dbHelper.ExecuteNonQuerySP("SP_Tokens_SyncTime", pars);
        ...
        public int TokensCheckActive(OTPs.CheckActiveSyncTime input)
        {
            try
            {
                ...
                _dbHelper.SetConnectionString(appSettings.BillingAuthenticationAPIConnectionString);
                _dbHelper.ExecuteNonQuerySP("SP_Tokens_CheckActive", pars);
        ...
        public int AccountVerifyOTP(OTPs.AccountVerifyOTPInput input)
        {
            try
            {
                ...
                pars[5] = new SqlParameter("@_ResponseStatus", SqlDbType.Int) { Direction = ParameterDirection.Output };
                _dbHelper.SetConnectionString(appSettings.BillingAuthenticationAPIConnectionString);
                _dbHelper.ExecuteNonQuerySP("SP_Account_VerifyOTP", pars);
        ...
        public int UpdateInfo(OTPs.UpdateInfo input)
        {
            ...
            try
            {
                ...
                _dbHelper.SetConnectionString(appSettings.BillingAuthenticationAPIConnectionString);
                _dbHelper.ExecuteNonQuerySP("SP_Accounts_UpdateInfo", pars);
        ...
        public int ActiveTwoFactor(OTPs.ActiveFactor input)
        {
            ...
            try
            {
                ...
                pars[5] = new SqlParameter("@_ResponseStatus", SqlDbType.Int) { Direction = ParameterDirection.Output };
                _dbHelper.SetConnectionString(appSettings.BillingAuthenticationAPIConnectionString);
                _dbHelper.ExecuteNonQuerySP("SP_OTPApp_ActiveTwoFactAuthenticator", pars);
        ...
        public int GetTwoFactorInfo(long accountID, out string tokenKey, out string secretKey)
        {
            ...
            try
            {
                ...
                _dbHelper.SetConnectionString(appSettings.BillingAuthenticationAPIConnectionString);
                _dbHelper.ExecuteNonQuerySP("SP_OTPApp_GetTwoFactAuthenticatorInfo", pars);
