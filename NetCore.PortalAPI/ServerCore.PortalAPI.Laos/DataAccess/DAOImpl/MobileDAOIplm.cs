...
namespace ServerCore.DataAccess.DAOImpl
{
    public class MobileDAOIplm : IMobileDAO
    {
        ...
        public MobileDAOIplm(IOptions<AppSettings> options)
        {
        ...
        public int GetFacebookAccount(long accountid, out string facebook)
        {
            try
            {
                ...
                SQLAccess.getAuthen().ExecuteScalarSP("SP_InvitedEvent_GetFacebookAccountByAccountID", pars);
        ...
        public int UpdateFacebookAccount(long accountid, string facebook)
        {
            try
            {
                ...
                pars[2] = new SqlParameter("@_ResponseStatus", SqlDbType.Int) { Direction = ParameterDirection.Output };
                SQLAccess.getAuthen().ExecuteScalarSP("SP_InvitedEvent_UpdateFacebookAccount", pars);
                int res = Convert.ToInt32(pars[2].Value);
                return res;
            }
            catch (Exception ex)
        ...
        public int SetBitEvent(long accountid, int quantity, int playedQuantity)
        {
            ...
            try
            {
                ...
                SQLAccess.getBilling().ExecuteNonQuerySP("SP_InvitedEvent_SetBit", pars);
        ...
        public List<InvitedEvent> GetEventAccountInfo(int accountid)
        {
            ...
            try
            {
                ...
                var result = SQLAccess.getBilling().GetListSP<InvitedEvent>("SP_InvitedEvent_Get", pars);
                if (result.Count <= 0)
                {
        ...
        public int SetInvitedEvent(int accountid, int quantity, int offset)
        {
            ...
            try
            {
                ...
                pars[3] = new SqlParameter("@_ResponseStatus", SqlDbType.Int) { Direction = ParameterDirection.Output };
                SQLAccess.getAuthen().ExecuteNonQuerySP("SP_InvitedEvent_Set", pars);
                return Convert.ToInt32(pars[3].Value.ToString());
            }
            catch (Exception ex)
            {
        ...
        public List<MobileBaseMoney> GetBaseMoney()
        {
            ...
            try
            {
                var result = SQLAccess.getAuthen().GetListSP<MobileBaseMoney>("SP_Mobile_Get_BaseMoney");
                return result;
            }
            catch (Exception ex)
            {
        ...
        public List<MobileLink> GetLinks(int type)
        {
            ...
            try
            {
                ...
                var result = SQLAccess.getAuthen().GetListSP<MobileLink>("SP_Mobile_Get_Links", pars);
                return result;
            }
            catch (Exception ex)
            {
        ...
        public List<MobileLink3> GetLinks3(int type)
        {
            try
            {
                SqlParameter[] pars = new SqlParameter[1];
                pars[0] = new SqlParameter("@type", type);
                var result = SQLAccess.getAuthen().GetListSP<MobileLink3>("SP_Mobile_Get_Links3", pars);
                return result;
            }
            catch (Exception ex)
            {
        ...
        public int UpdateEmail(long accountid, string email)
        {
            ...
            try
            {
                ...
                var result = SQLAccess.getAuthen().ExecuteNonQuerySP("SP_Accounts_AddEmail", pars);
                return result;
            }
            catch (Exception ex)
            {
        ...
        public List<MobileVersion> GetVersion(string os, int partner_id)
        {
            ...
            try
            {
                ...
                var result = SQLAccess.getAuthen().GetListSP<MobileVersion>("SP_Mobile_Get_Version", pars);
                return result;
            }
            catch (Exception ex)
            {
        ...
        public int SetEvent(string eventUrl, string eventImageUrl, string gitfUrl)
        {
            ...
            try
            {
                ...
                var result = SQLAccess.getAuthen().ExecuteNonQuerySP("SP_Mobile_SetEvent", pars);
                return result;
            }
            catch (Exception ex)
            {
