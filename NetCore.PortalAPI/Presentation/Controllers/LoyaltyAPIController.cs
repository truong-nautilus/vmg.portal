...
namespace PortalAPI.Controllers
{
    ...
    public class LoyaltyAPIController : ControllerBase
    {
        ...
        public LoyaltyAPIController(AccountSession accountSession, OTPSecurity otp, CoreAPI coreAPI, IOptions<AppSettings> options, IGameTransactionRepository coreRepository)
        {
