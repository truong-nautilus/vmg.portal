...
namespace ServerCore.PortalAPI.Presentation.Controllers
{
    ...
    public class FishingController : ControllerBase
    {
        ...
        public FishingController(AccountSession accountSession, IHostingEnvironment env, IAuthenticateService authenticateService, IOptions<AppSettings> options, IAccountRepository accountRepository, CoreAPI coreAPI, OTPSecurity otp)
        {
        ...
        public ActionResult<ResponseBuilder> ChangeMoney([FromBody] dynamic data)
        {
            ...
            int responseStatus = _accountRepository.ChangeMoneyFishing(otpData.AccountId, amount, desc, type, otpData.PlatformId, out fishingInfo);
